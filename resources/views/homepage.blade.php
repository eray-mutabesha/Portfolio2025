...
<body class="dark">
  ...
  <main>
    ...
    <section id="home" class="position-relative">
      ...
      <div class="bg-blurred-red-2"></div>
      <div class="bg-blurred-purple-1"></div>
      <div class="container">
        <div class="row align-items-center position-relative">
          <div class="col-lg-12">
            <div class="d-flex w-100 justify-content-center" style="opacity: 0.8;">
              <img src="assets/images/eray004.png" alt="" class="d-inline-block wow fadeScaleOutIn"
          ...
          <div class="position-lg-absolute">
            <div class="row align-items-center justify-content-center justify-content-lg-start">
              <!-- First Name -->
              <div class="col-lg-12">
                <h1 class="text-center text-lg-start w-100 section-title-s6 wow fade-right" data-splitting="chars"
                  data-splitting-duration="1.2s" data-splitting-delay="0.4s">Eray</h1>
              </div>
              <!-- /First Name -->
              <!-- Last Name -->
              <div class="col-lg-6 order-lg-3">
                <h1 class="section-title-s6 text-center text-lg-start w-100 wow fade-right" data-splitting="chars"
                  data-splitting-duration="1.4s" data-splitting-delay="0.8s">Dev</h1>
              </div>
              <!-- /Last Name -->
              <!-- About -->
              <div
                class="section-home-text-2 text-lg-start position-lg-absolute end-0 mb-32 mt-24 mt-lg-0 col-xl-3 col-lg-4">
                <p class="text-gray-3 wow fadeInUp" data-wow-delay="1.8s">I am a software developer
                     dedicated to crafting <span class="text-light-gray-1 fw-600">high-performance, scalable, and user-centric applications.</span>  With expertise in modern technologies and a problem-solving mindset, I turn ideas into seamless digital experiences.

                <div class="mt-24 wow fadeInUp" data-wow-delay="2s">
                  <p class="fs-lg fw-500">Follow Me</p>
                  <div class="social-media-list-s1 justify-content-lg-start wow fadeInLeft" data-wow-offset="20">
                    <a href="https://www.facebook.com/dieumercie.mutabesha/">
    ...
    <section class="page-section" id="service">
      <div class="container position-relative">
        ...
        <div class="row">
          <div class="col-lg-4">
            <!-- Service Box -->
            <div class="service-box-s1 wow fadeInLeft">
              <div class="icon">
          ...
          <div class="col-lg-4">
            <!-- Service Box -->
            <div class="service-box-s1 wow fadeInLeft" data-wow-delay="0.2s">
              <div class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path
          ...
          <div class="col-lg-4">
            <!-- Service Box -->
            <div class="service-box-s1 wow fadeInLeft" data-wow-delay="0.4s">
              <div class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path
    ...
    <section class="page-section" id="about">
      <div class="container">
          ...
          <div class="col-lg-5 mb-5 mb-lg-0">
            ...
            <div class="img-wrap-s2">
              <div class="img-wrap-s2-inner">
                ...
                <img src="assets/images/eray006.png" alt="" class="d-inline-block wow fadeScaleOutIn"
        ...
        <div class="row">
          <div class="col-12">
            <h3 class="section-title-s5 stroke-text-bolder text-center mb-48 mb-xl-56 wow fade-right"
              data-splitting="chars">
              My Expertise</h3>
          </div>
          <div class="col-lg-6 position-relative mb-40 mb-lg-0">
            <div class="bg-blurred-red"></div>
            <div class="bg-blurred-purple"></div>
    ...
    <section class="page-section position-relative">
      ...
      <div class="container position-relative">
        ...
        <div class="page-section-title row">
          ...
          <div class="col-lg-8 offset-lg-2">
            <p class="section-title-s4 mb-0 wow fade-right" data-splitting="chars" data-splitting-delay="1s">Client
              Success
              in
              Their Own Words</p>
          </div>
        ...
        <!-- Testimonial Slider -->
        <div class="testimonial-slider swiper pt-0">
